...
<html lang="es">
    ...
    <body class="text-center">
        <div class="container">
            ...
            <div class="row">
                <footer class="text-center ml-5" style="font-size: 12px;">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <input type="password" class="form-control text-center mb-3" id="register-password" placeholder="Ingresa tu contraseña" style="font-size: 12px;" required>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <label for="register-dup-password">Valida Contraseña</label>
                                        <input type="password" class="form-control text-center mb-3" id="register-dup-password" placeholder="Ingresa nuevamente tu contraseña" style="font-size: 12px;" required>
                                    </div>
                                </div>
                            </div>
                    </div>
